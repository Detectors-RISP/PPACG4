...
//
//
// $Id: PPACElectricFieldSetup.hh,v 1.2 2006-06-29 17:17:12 gunter Exp $
...
#ifndef PPACElectricFieldSetup_H
#define PPACElectricFieldSetup_H
...
class PPACFieldMessenger;
class PPACElectricFieldSetup 
{
public:

  PPACElectricFieldSetup(G4ThreeVector) ;  //  The value of the field
  PPACElectricFieldSetup() ;               //  A zero field

 ~PPACElectricFieldSetup() ;  
...
private:
  ...
  G4double                fMinStep ;
  G4double                fLocalMinStep ;
 
  PPACFieldMessenger*      fFieldMessenger;

...
// $Id$
// 
/// \file PPACEventActionMessenger.cc
/// \brief Implementation of the PPACEventActionMessenger class
...
PPACEventActionMessenger::PPACEventActionMessenger(PPACEventAction* eventAction)
 : G4UImessenger(),
...
PPACEventActionMessenger::~PPACEventActionMessenger()
{
...
void PPACEventActionMessenger::SetNewValue(

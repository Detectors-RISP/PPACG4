...
//
//
// $Id: PPACFieldMessenger.cc,v 1.8 2008-05-14 15:27:13 tnikitin Exp $
...
PPACFieldMessenger::PPACFieldMessenger(PPACElectricFieldSetup* pEMfield)
  :fEFieldSetup(pEMfield)
{ 
  PPACdetDir = new G4UIdirectory("/field/");
  PPACdetDir->SetGuidance("PPAC field tracking control.");
...
PPACFieldMessenger::~PPACFieldMessenger()
{
  delete StepperCmd;
  delete ElFieldCmd;
  delete MinStepCmd;
...
void PPACFieldMessenger::SetNewValue( G4UIcommand* command, G4String newValue)
{ 

...
export G4INSTALL=/opt/geant4.9.5.p01
export G4INCLUDE=/home/kblee/GEANT4
export G4LIB=/opt/geant4.9.5.p01-build/outputs/library

if test "x$LD_LIBRARY_PATH" = "x" ; then
  export LD_LIBRARY_PATH=/opt/geant4.9.5.p01-build/outputs/library/Linux-g++
else
  export LD_LIBRARY_PATH=/opt/geant4.9.5.p01-build/outputs/library/Linux-g++:${LD_LIBRARY_PATH}
fi
...
#
export G4ABLADATA=/opt/geant4.9.5.p01-build/data/G4ABLA3.0
export G4LEDATA=/opt/geant4.9.5.p01-build/data/G4EMLOW6.23
export G4LEVELGAMMADATA=/opt/geant4.9.5.p01-build/data/PhotonEvaporation2.2
export G4NEUTRONHPDATA=/opt/geant4.9.5.p01-build/data/G4NDL4.0
export G4NEUTRONXSDATA=/opt/geant4.9.5.p01-build/data/G4NEUTRONXS1.1
export G4PIIDATA=/opt/geant4.9.5.p01-build/data/G4PII1.3
export G4RADIOACTIVEDATA=/opt/geant4.9.5.p01-build/data/RadioactiveDecay3.4
export G4REALSURFACEDATA=/opt/geant4.9.5.p01-build/data/RealSurface1.0
